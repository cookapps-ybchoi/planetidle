...
public class UEListContainer : MonoBehaviour
{
    ...
    private void InitData(bool keepPostion = false)
    {
        ...
        if (this.scrollRect.vertical)
        {
            ...
            this.itemCount = (int)(Mathf.Abs(Mathf.Ceil(this.scrollRectValue.height / this.cellheight)) + 2) * this.countPerLine;
        ...
        else
        {
            ...
            this.itemCount = (int)(Mathf.Abs(Mathf.Ceil(this.scrollRectValue.width / this.cellwidth)) + 2) * this.countPerLine;
        }
